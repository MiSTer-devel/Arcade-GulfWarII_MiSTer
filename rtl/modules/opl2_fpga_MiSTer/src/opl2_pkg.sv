...
package opl2_pkg;
    /*
     * Gulf War II drives the YM3812 from 28 MHz / 8 = 3.5 MHz. The OPL2 core's
     * operator pipeline advances at chip clock / 72, so target 48.611 kHz.
     */
    localparam CLK_FREQ = 70e6; // Gulf War II runs this core from clk_sys.
    localparam int CLK_DIV_COUNT = 1440; // 70 MHz / 1440 = 48.611 kHz.
    ...
    /*
     * Derived timing for the local Gulf War II integration.
     */
    localparam DESIRED_SAMPLE_FREQ = 48.6111e3;
